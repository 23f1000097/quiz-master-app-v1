...
class Question(db.Model):
    ...
    option2 = db.Column(db.String(80), unique = True, nullable = False)
    option3 = db.Column(db.String(80), unique = True, nullable = False)
    option4 = db.Column(db.String(80), unique = True, nullable = False)
